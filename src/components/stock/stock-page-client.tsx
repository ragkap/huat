      ...
      {primer && (primer.executive_summary.length > 0 || primer.three_bullish_points.length > 0 || primer.three_bearish_points.length > 0 || primer.key_risks.length > 0) && (
        <div className="px-5 py-4 border-b border-[#282828] space-y-3">
          ...
          {primer.executive_summary.length > 0 && (
            <div className="widget-hover relative overflow-hidden border border-[#282828] rounded-lg p-4 cursor-pointer" onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setSummaryExpanded(v => !v); }}>
              ...
              <button onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setSummaryExpanded(v => !v); }} className="mt-2 text-[11px] text-[#71717A] hover:text-[#F0F0F0] transition-colors">
          ...
          {(primer.three_bullish_points.length > 0 || primer.three_bearish_points.length > 0) && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {primer.three_bullish_points.length > 0 && (
                <div className="widget-hover relative overflow-hidden border border-[#282828] rounded-lg p-4 cursor-pointer" onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setBullishExpanded(v => !v); }}>
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <button onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setBullishExpanded(v => !v); }} className="mt-2 text-[11px] text-[#71717A] hover:text-[#F0F0F0] transition-colors">
                    {bullishExpanded ? "Show less" : "Show more"}
                  </button>
                </div>
              )}
              {primer.three_bearish_points.length > 0 && (
                <div className="widget-hover relative overflow-hidden border border-[#282828] rounded-lg p-4 cursor-pointer" onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setBearishExpanded(v => !v); }}>
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <button onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setBearishExpanded(v => !v); }} className="mt-2 text-[11px] text-[#71717A] hover:text-[#F0F0F0] transition-colors">
          ...
          {primer.key_risks.length > 0 && (
            <div className="widget-hover relative overflow-hidden border border-[#282828] rounded-lg p-4 cursor-pointer" onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setRisksExpanded(v => !v); }}>
              <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={(e: React.MouseEvent<HTMLElement>) => { ripple(e); setRisksExpanded(v => !v); }} className="mt-2 text-[11px] text-[#71717A] hover:text-[#F0F0F0] transition-colors">
